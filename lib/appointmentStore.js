...
// BUG: this only compares doctor + time — it forgets to also require
// a.date === b.date, so the same doctor at the same time on two different
// days is incorrectly flagged as conflicting.
